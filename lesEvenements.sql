...
-- Listage des données de la table lesevenements.comment : ~10 rows (environ)
DELETE FROM `comment`;
INSERT INTO `comment` (`id_comment`, `titleComment`, `comment`, `creationDate`, `event_id`, `user_id`) VALUES
	...
	(39, 'Wahhhh', 'Plein les yeux.', '2023-05-19 15:53:41', 10, 20),
	(41, 'test', '123', '2023-06-06 11:59:52', 10, 7),
	(42, 'Une maison bleue ?', 'Et elle est adossée à la colline ?', '2023-06-08 14:57:19', 14, 20),
	(43, 'Où les éléphants', 'Sont roses.', '2023-06-08 14:58:04', 14, 20);
...
INSERT INTO `event` (`id_event`, `titleEvent`, `description`, `zipcode`, `address`, `city`, `country`, `dateStart`, `dateEnd`, `maxUsers`, `contribution`, `imgEvent`, `alt`, `user_id`, `category_id`) VALUES
	...
	(3, 'Tournoi d\'échecs', 'Appel à tous les amoureux du jeu d\'échecs....', '67200', '', 'Strasbourg', 'France', '2023-02-15 09:32:46', '2023-02-15 09:32:47', 200, 5.000000, 'Echecs2.jpg', 'Echecs', 4, 3),
	(4, 'Le livre toujours', 'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quia, assumenda est, amet minus distinctio incidunt et maiores autem quaerat rem, error asperiores iste temporibus id voluptatibus eaque provident fugit tempora.', '67100', '', 'Strasbourg', 'France', '2023-02-20 08:16:47', '2023-02-20 08:16:47', 450, 0.000000, 'image_livre.jpg', 'Image de livre', 1, 1),
	(5, 'Toujours plus haut', 'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quia, assumenda est, amet minus distinctio incidunt et maiores autem quaerat rem, error asperiores iste temporibus id voluptatibus eaque provident fugit tempora.', '67300', '', 'Schiltigheim', 'France', '2023-02-20 08:21:19', '2023-02-20 08:21:19', 500, 0.000000, 'Capture-escalade.png', 'femme sur un mur d\'escalade', 2, 2),
	(6, 'Du son', 'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quia, assumenda est, amet minus distinctio incidunt et maiores autem quaerat rem, error asperiores iste temporibus id voluptatibus eaque provident fugit tempora.', '67000', '', 'Strasbourg', 'France', '2023-02-20 08:24:30', '2023-02-20 08:24:30', 800, 95.000000, 'Orchestre_Philharmonique_de_Strasbourg_1.jpg', 'Orchestre philharmonique de Strasbourg', 1, 1),
	(7, 'On joue à Berstett', 'Cette balade est destinée aux familles avec enfants de 4 à plus de 10 ans. Vous serez amenés à répondre à plusieurs énigmes portant sur le patrimoine et la culture de Berstett tout en visitant le village. Un moyen ludique pour en apprendre un peu plus sur les trésors de cette commune ! Venez ensuite donner vos réponses à l\'Office de Tourisme et si elles s\'avèrent justes, un petit cadeau bien mérité vous attend !', '67000', '', 'Strasbourg', 'France', '2023-02-20 14:19:22', '2023-02-22 20:19:36', 300, 0.000000, 'ferme-Berstett.jpg', 'Ferme Berstett', 1, 3),
	...
	(9, 'A vos plumes', 'Un marthon d\'écriture...', '67000', '', 'Strasbourg', 'France', '2023-09-15 12:51:13', '2023-02-15 14:51:01', 1000, 0.000000, 'write-a-story.jpg', 'Write a story', 3, 1),
	...
	(11, 'Découverte de la Petite-france', 'Un cadre idillyque à redécouvrir. Lorem, ipsum dolor sit amet consectetur adipisicing elit. Est tempore numquam et aut illum pariatur impedit dignissimos vitae aperiam, cum ipsa assumenda officia blanditiis, necessitatibus, fuga dolorem modi maxime expedita quasi. Atque veniam quaerat eius.', '67000', '', 'Strasbourg', 'France', '2023-09-28 05:00:00', '2023-09-28 13:00:00', 50, 0.000000, 'petite-france-strasbourg.jpg', 'Petite-france Strasbourg', 3, 3),
	(12, 'Rétrospective de Un Tel', 'Une exposition à vous couper le souffle', '67000', '', 'Strasbourg', 'France', '2023-09-27 20:00:00', '2023-10-12 20:00:00', 80, 10.000000, 'exposition.jpg', 'Exposition', 2, 1),
	...
	(15, 'Le vélo-rail de Drulingen', 'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quia, assumenda est, amet minus distinctio incidunt et maiores autem quaerat rem, error asperiores iste temporibus id voluptatibus eaque provident fugit tempora.', '67320', '6 rue de Weyer', 'Drulingen', 'France', '2024-04-22 07:24:13', '2024-02-29 09:24:37', 40, 50.000000, 'Velorail-Drulingen.jpg', 'Vélo-rail de Drulingen', 7, 2);
...
-- Listage des données de la table lesevenements.participate : ~7 rows (environ)
...
INSERT INTO `user` (`id_user`, `firstName`, `lastName`, `email`, `pseudo`, `password`, `status`, `banish`, `registerDate`) VALUES
	...
	(20, 'Ad', 'Min', 'admin@gmail', 'Admin', '$2y$10$XKHcPYtq.ThH3bXUX6ma5uYImLO7nTuzIZHLYABwjb0gtO1sneqWa', 'admin', 0, '2023-05-19 16:44:05'),
	(21, 'Mo', 'Do', 'modo@gmail.com', 'Modo', '$2y$10$Qd8zYYH4JMo7C7O/tHareutpxiQxI/Me99ncwO2TnTerYzIzqBRFC', 'moderator', 0, '2023-05-19 16:45:05'),
	(22, 'Us', 'Er', 'user@gmail.com', 'User', '$2y$10$oRkMv2GvvL9TP0ITEKlSJ.DQZgjfFDhfgKjd9bfSMSgFhyiXfFFBS', 'user', 0, '2023-05-19 16:45:47');
